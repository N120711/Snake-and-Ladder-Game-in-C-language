...
show()
{
printf("\n\n\t\t*******************************************************\n\t\t*               SNAKES AND LADDERS GAME TUTORIAL      *\n\t\t*******************************************************\n\t\t* 1. Choose your option from main menu                *\n\t\t* 2. If your option is cpu player just Enter your Name*\n\t\t*    and  password.				      *\n\t\t* 3.This password is used in future to reload the game*\n\t\t*    if you save the game...                          *\n\t\t* 4.Press Enter to through Your Dice...               *\n\t\t* 5.See your moves at right side of pannel            *\n\t\t*                                                     *\n\t\t*******************************************************\n\n\n");
}
